class ElementView extends egret.Sprite {
	...
	private canRemove() {
		var evt: ElementViewManagerEvent = new ElementViewManagerEvent(ElementViewManagerEvent.REMOVE_ANIMATION_OVER);
	...
	private overCurveMove() {
		...
		var evt: ElementViewManagerEvent = new ElementViewManagerEvent(ElementViewManagerEvent.UPDATE_MAP);
		this.dispatchEvent(evt);
	}
