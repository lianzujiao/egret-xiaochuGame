...
var LevelReqViewManager = (function () {
    function LevelReqViewManager(layer) {
        this._layer = layer;
        this.init();
    }
    LevelReqViewManager.prototype.init = function () {
        this.elements = new Array();
    };
    //创建当前关卡的过关条件元素
    LevelReqViewManager.prototype.createCurrentLevelReq = function () {
     ...
     */
    LevelReqViewManager.prototype.haveReqType = function (type) {
     ...
     */
    LevelReqViewManager.prototype.getPointByType = function (type) {
     ...
     * 更新关卡过关元素数据
     */
    LevelReqViewManager.prototype.update = function () {
    ...
    //更新步数
    LevelReqViewManager.prototype.updateStep = function () {
        this.stepNumText.text = GameData.stepNum.toString();
    };
    return LevelReqViewManager;
}());
__reflect(LevelReqViewManager.prototype, "LevelReqViewManager");
//# sourceMappingURL=LevelReqViewManager.js.map